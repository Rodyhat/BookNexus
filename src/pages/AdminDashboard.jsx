    ...
    return (
        <section className="w-full">
            ...
            <div className="grid my-7 gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                <div className="bg-white p-6 w-full rounded-[8px] shadow-sm border border-transparent transition-colors duration-600 hover:border-primary-container">
                ...
                <div className="bg-white p-6 w-full rounded-[8px] shadow-sm border border-transparent transition-colors duration-600 hover:border-tertiary-container">
                    <div className="flex items-center justify-between">
                ...
                <div className="bg-white p-6 w-full rounded-[8px] shadow-sm border border-transparent transition-colors hover:border-secondary-container duration-600">
                ...
                <div className="bg-white p-6 w-full rounded-[8px] shadow-sm border border-transparent transition-colors duration-600 hover:border-error">
                    <div className="flex items-center gap-4 justify-between">
